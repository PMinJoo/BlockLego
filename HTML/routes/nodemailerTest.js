...
<<<<<<< HEAD
    res.send('<script type="text/javascript">var s = "<%- JSON.stringify(key) %>"; alert("회원가입이 완료되었습니다." + s);document.location.href="/index.html";</script>');
=======
<<<<<<< HEAD
...
>>>>>>> 2c7a82eb6fcbec88af754f2ea45ecbaddf22f325
  })
